    ...
    form_hub.content.push(
      {
        text: [
          ...
          {
            text:
              "\t\t\tPursuant to the ordinance of this Barangay , this CLEARANCE is granted to  ",
            fontSize: 12
          },
          ...
          {
            text:
              "\t\t\tApplicant is hereby advised to follow  all existing laws and ordinances in relation with the conduct of his/her business.Violation of the same sound is a ground for revocation of this clearance.\n\n\t\tClearance is valid up to " +
              details.exp_date.month +
              " " +
              details.exp_date.day +
              "," +
              details.exp_date.year +
